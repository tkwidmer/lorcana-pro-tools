...
|---|---|---|
| `/` | `HomePage.jsx` | Dashboard — tool catalog organized into Resources, Deckbuilding, Coaching Tools, Metagame, Tournament Tools, Content Creators (+ Community when the Discord bot is configured). The catalog lives in `src/lib/siteSections.js` |
